...
<!-- <p class="max-w-3xl text-base leading-7 text-white/70"> -->
无论是工作还是娱乐，使用我们的互联网加速服务，确保您畅享全球内容。让您不再受地域限制，随时访问全球热门应用。
<!-- </p> -->

## <!-- <ul class="mt-4 space-y-3 text-sm"> -->服务特点

<!-- <li class="flex items-start gap-2"><i class="i-solar-check-circle-outline mt-0.5 text-primary"></i><span> -->
...
<!-- <div class="relative hidden md:block"><img src="./images/earth_purple.webp" alt="earth illustration" class="mx-auto w-56 lg:w-80 object-contain"></div> -->
